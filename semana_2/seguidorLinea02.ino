// =====================================================
// seguidorLinea02 — Seguidor de Línea con millis()
...
//    1 |  1 | detener
//
// millis() controla el intervalo de muestreo sin bloquear
// el microcontrolador — a diferencia de delay(), el loop
// sigue corriendo y puede atender otras tareas en paralelo.
// =====================================================
